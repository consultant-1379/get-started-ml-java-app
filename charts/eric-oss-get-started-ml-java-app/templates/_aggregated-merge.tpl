...
*/ -}}
{{- define "eric-oss-get-started-ml-java-app.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-get-started-ml-java-app.mergeAnnotations" -}}
  {{- include "eric-oss-get-started-ml-java-app.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-get-started-ml-java-app.mergeLabels" -}}
  {{- include "eric-oss-get-started-ml-java-app.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
