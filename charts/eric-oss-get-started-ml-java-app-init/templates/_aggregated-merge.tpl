...
*/ -}}
{{- define "eric-oss-get-started-ml-java-app-init.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-get-started-ml-java-app-init.mergeAnnotations" -}}
  {{- include "eric-oss-get-started-ml-java-app-init.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-get-started-ml-java-app-init.mergeLabels" -}}
  {{- include "eric-oss-get-started-ml-java-app-init.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
